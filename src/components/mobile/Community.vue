<template>
  <div
    class="container"
    style="position:fixed;left:0;top:0;width: 100%;height: 100%; overflow-y:auto;box-sizing: border-box;"
  ...
  >
    ...
    >
      ...
      <section
        ...
        :key="index"
        :style="index > 0 ? paddingStyle: ''"
      >
        <el-row>
          <el-col :span="3">
            <el-avatar
              shape="square"
              :src="'/images'+comment.headImg"
            >
        ...
        <el-row>
          <el-col>
            <div @click="toDetail(comment.id)">{{comment.content}}</div>
          </el-col>
        </el-row>

        <el-row v-if="comment.contentImg">
          <el-col :span="12">
            <el-image :src="'/images'+comment.contentImg"></el-image>
          </el-col>
        </el-row>
        <el-row style="margin-top: 10px;line-height: 20px;">
          <el-col :span="8">
            <span>
              <div
                @click="toDetail(comment.id)"
                style="color: gray;"
              >{{comment.createTime.substr(5, 11)}}</div>
            </span>
          </el-col>
      ...
      <section
        ...
        v-if="page.totalPage <= page.pageNo"
      ><span>没有更多</span></section>
